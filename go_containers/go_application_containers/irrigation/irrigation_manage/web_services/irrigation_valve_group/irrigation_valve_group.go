package irrigation_valve_group
...
func Generate_page_adjust(w http.ResponseWriter, r *http.Request){
    ...
    data["Title"] = "Irrigation Diagnostics Valve Group"
...
func generate_main_component()web_support.Sub_component_type{
    ...
    return_value.Append_line(web_support.Generate_title("Valve Group Irrigation Diiagnostic"))
