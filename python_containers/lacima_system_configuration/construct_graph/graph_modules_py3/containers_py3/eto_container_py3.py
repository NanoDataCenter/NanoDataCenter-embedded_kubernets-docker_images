...
class ETO_CONTAINER(object):
     ...
     def __init__(self,bc,cd,name):
          start_command = "docker run    -d  --network host   --name eto   --mount type=bind,source=/home/pi/mountpoint/lacuma_conf/site_config,target=/data/"
          start_command =  start_command + "  nanodatacenter/eto /bin/bash process_control.bsh "
