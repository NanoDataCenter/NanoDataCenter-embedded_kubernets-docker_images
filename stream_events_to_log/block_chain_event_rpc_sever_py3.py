...
class Construct_RPC_Server(object):
   ...
   def fetch_block_chain_data(self,input_msg ):
       ...
       contract_number = input_msg["contract_name"]
       encode_data = self.el.get_contract_logs(contract_name,start_block,end_block)
   ...
   def decode_data(self,data):  # make sure data can be decode from block chain
       ...
       for  i in data:
           ...
           try:
               ...
               return_value.append(msgpack.unpackb(decode))
