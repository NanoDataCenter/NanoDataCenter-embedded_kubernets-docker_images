...
class System_Control(object):
   ...
   def update_process_status(self,script,data):   
       ...
       if temp_data != data:
           ...
           self.system_error_logging.log_error_message("Process_Change_State",["script",script])
       else:
          pass
          #print("******************************************   data is equal")
...
if __name__ == "__main__":
   ...
   system_error_logging = System_Error_Logging(qs,"Node_Control",site_data,sqlite_client)
