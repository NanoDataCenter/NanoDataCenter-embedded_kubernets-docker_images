...
class Monitoring_Base(object):
   ...
   def __init__(self,file_server_library,file_name,completion_dictionary,job_queue,active_function=None):
...
class System_Monitoring(Monitoring_Base): 
   ...
   def __init__(self, file_server_library,completion_dictionary,job_queue):
       
       Monitoring_Base.__init__(self,file_server_library,"system_actions.json",completion_dictionary,job_queue)
...
class Irrigation_Schedule_Monitoring(Monitoring_Base):
   def __init__(self, file_server_library,completion_dictionary,job_queue,irrigation_control ):
       Monitoring_Base.__init__(self,file_server_library,"sprinkler_ctrl.json",completion_dictionary,job_queue,self.rain_check)
