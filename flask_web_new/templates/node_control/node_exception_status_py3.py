...
class Node_Exception_Status(Base_Multi_Template_Class,Node_Base_Class):
   ...
   def process_html(self):
       ...
       self.mp.generate_log_data = self.generate_status_data
...
<h4>Exception Status for Node Control processes processor {{self.processor_name}} </h4>
